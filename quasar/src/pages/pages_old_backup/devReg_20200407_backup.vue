...
export default {
  ...
  methods: {
    ...
    getTwo: function () {
      ...
      const requestTwo = axios.get('http://api.frrut.net:1337/last-dev-data/')
      ...
      axios.all([requestOne, requestTwo, requestThree]).then(axios.spread((...responses) => {
        ...
        var filDevList = []
        for (let m = 0; m < this.deviceList.length; m++) {
          if (this.deviceList[m].deviceRegiStatus === false) {
            this.deviceList.push(filDevList[m])
          }
        }
        console.log('how many false :' + filDevList.length)
        console.log('filDevList*************')
        console.log(filDevList)
